            ...
            <div class="p-6 flex flex-col h-full">
                ...
                <ul class="flex flex-col gap-4 mb-8 flex-grow">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <span class="text-on-surface text-sm <?= $plan->allow_messages ? 'font-medium' : 'text-outline-variant opacity-70 line-through' ?>">Direct In-App Messaging</span>
                    </li>
                    <li class="flex items-center gap-3">
                        ...
                        <span class="text-on-surface text-sm <?= $plan->direct_email_inquiry ? 'font-medium' : 'text-outline-variant opacity-70 line-through' ?>">Direct Email & Phone Inquiries</span>
                    </li>
                </ul>
