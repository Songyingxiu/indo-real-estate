...
<!-- FIX: Added 'grid grid-cols-1 min-w-0 w-full' wrapper. -->
<!-- This breaks the parent flexbox's implicit width expansion, forcing the page scrollbar to disappear. -->
<div class="grid grid-cols-1 min-w-0 w-full">
    <div class="pb-12 px-4 sm:px-6 lg:px-8" x-data="{ 
        ...
        <!-- Kanban Container -->
        <div class="bg-surface-container-lowest border border-outline-variant rounded-xl p-4 sm:p-6 shadow-sm w-full">
            <!-- Scrollable Kanban Track -->
