        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="file" name="property_images[]" required multiple accept="image/*" @change="validateImageCount($event)" class="w-full p-2 border rounded p-1 <?= $err ? 'border-[#c9302c] bg-[#fff8f8]' : 'border-outline-variant bg-surface' ?>">
                ...
                <div>
                    ...
                    <input type="file" name="shm_document" required accept=".pdf,.jpg,.jpeg,.png" class="w-full p-2 border rounded p-1 <?= $err ? 'border-[#c9302c] bg-[#fff8f8]' : 'border-outline-variant bg-surface' ?>">
                    <?= $errBox($err) ?>
                </div>
            </div>
        </div>
