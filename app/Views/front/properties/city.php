...
<main class="max-w-[1280px] mx-auto px-4 md:px-10 py-10 min-h-[calc(100vh-80px)]">
    <div class="mb-6">
        <h1 class="font-headline-lg text-[32px] font-bold text-on-background"><?= lang('Front.prop_in_city') ?> <?= esc($city['name'] ?? 'this City') ?></h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <?php endforeach; else: ?>
            <p class="col-span-full text-center text-on-surface-variant py-8"><?= lang('Front.prop_no_city') ?></p>
        <?php endif; ?>
    </div>
