<div id="auth-modal-overlay" class="fixed inset-0 z-[500] flex items-center justify-center p-4 transition-opacity duration-300" style="background-color: rgba(24, 28, 30, 0.4); backdrop-filter: blur(4px); display: none;">
    ...
    <div aria-labelledby="modal-title" aria-modal="true" class="bg-surface-container-lowest w-full max-w-md rounded-lg border border-outline-variant shadow-2xl relative overflow-hidden flex flex-col transform transition-transform duration-300 scale-95 opacity-0" role="dialog" id="auth-modal-box">
        ...
        <button type="button" onclick="closeAuthModal()" aria-label="Close modal" class="absolute top-4 right-4 text-on-surface-variant hover:text-on-surface transition-colors p-2 rounded-full hover:bg-surface-container-low">
        ...
        <div class="p-8 flex flex-col gap-6">
            <div class="flex items-center gap-2 mb-2 justify-center">
                ...
                <span class="font-brand-text text-[20px] font-bold text-primary">HuniKita</span>
            </div>
            ...
            <form action="<?= base_url('login') ?>" method="POST" class="flex flex-col gap-4 mt-2">
                ...
                <div class="flex flex-col gap-1">
                    <div class="flex justify-between items-center">
                        ...
                        <a class="font-label-md text-[13px] font-semibold text-primary hover:underline" href="<?= base_url('forgot-password') ?>">Forgot?</a>
                    </div>
                    <div class="relative">
                ...
                <a href="<?= base_url('register') ?>" class="w-full mt-2 bg-transparent border border-primary-container text-primary-container font-label-md text-[15px] font-semibold py-3 rounded hover:bg-surface-container-low transition-colors flex items-center justify-center text-center">
                    Create an account
                </a>
            </form>
